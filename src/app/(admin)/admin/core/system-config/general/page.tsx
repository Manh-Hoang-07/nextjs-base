...
import SystemConfigForm from "@/components/admin/core/system-config/SystemConfigForm";
import ContactChannelsManager from "@/components/admin/core/system-config/contactChannelsManager";
...
export default function AdminSystemConfigGeneralPage() {
  const fields: any[] = [
    ...
    { key: "site_address", label: "Địa chỉ", type: "textarea", placeholder: "Nhập địa chỉ trụ sở" },
