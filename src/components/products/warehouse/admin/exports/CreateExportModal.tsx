...
export default function CreateExportModal({ show, onClose, onCreated, apiErrors }: CreateExportModalProps) {
    ...
    const updateItem = (tempId: number, field: keyof ExportItem, value: any) => {
